            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="velvet-privacy-modal fixed left-1/2 top-1/2 z-50 max-h-[86vh] w-[calc(100%-2rem)] max-w-2xl -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl border border-[#4a3154] bg-[#11121a] shadow-[0_24px_90px_rgba(0,0,0,.65)]">
                    ...
                    <div className="max-h-[58vh] space-y-6 overflow-y-auto px-6 py-6 text-sm leading-6 text-gray-300 sm:px-8">
                        <section><h2 className="font-semibold text-[#e5a1f2]">1. Responsable</h2><p className="mt-2">The Velvet Studio será responsable del tratamiento de los datos que recibamos a través de este formulario. Para solicitudes relacionadas con privacidad puedes escribir a <a className="text-[#e5a1f2] underline" href="mailto:privacidad@thevelvetstudio.co">privacidad@thevelvetstudio.co</a>.</p></section>
